...
#croncmd_backup="docker exec -it postgres-container bash -c '/backup.sh'"
#cronjob_backup="0 2 * * * $croncmd_backup"
#
#crontab -l | grep -v -F "$croncmd_backup" ; echo "$cronjob_backup"
#
#/usr/sbin/crond -f -l 8
